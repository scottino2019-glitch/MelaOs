            ...
            {activeDoc && (
              <div className="p-3 border-t border-neutral-150 bg-neutral-50">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 py-1.5 bg-red-550 hover:bg-red-600 text-white text-[10px] font-bold rounded-lg border border-red-500 transition-all focus:outline-none"
                >
                  <Trash2 size={12} />
